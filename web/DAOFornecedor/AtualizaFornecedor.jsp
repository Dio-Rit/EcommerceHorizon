...
<html>
    ...
    <body>
        ...
        <div id="EditarFornecedor">
            ...
            <form name="AcaoFornecedor" id="AcaoFornecedor" method="post" action="AcaoFornecedor?param=EditarFornecedor">
                ...
                <center>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" id="email" name="email" aria-describedby="email" placeholder="Digite seu email" required="" value="<%= usu.getEmail()%>">
                    </div>
